      ...
      render={({ control, data }) => (
        <>
          ...
          <div className='two-col-content'>
            ...
            >
              <RadioGroup options={YES_NO_OPTIONS} control={control} name={DELETED_RECORDS} />
            </Option>
            <Option
            ...
            >
              <RadioGroup options={YES_NO_OPTIONS} control={control} name={LIFE_TIME} />
            </Option>
            <Option
            ...
            >
              <RadioGroup options={YES_NO_OPTIONS} control={control} name={ADMIN_EMAIL} />
            </Option>
            <Option
            ...
            >
              <RadioGroup options={YES_NO_OPTIONS} control={control} name={IDENTIFY_DESCRIPTION} />
            </Option>
            <Option
            ...
            >
              <RadioGroup options={YES_NO_OPTIONS} control={control} name={PROGRESSIVE_DELIVERY} />
            </Option>
            <Option
            ...
            >
              <RadioGroup options={YES_NO_OPTIONS} control={control} name={RECORDS_SIZE} />
            </Option>
            <Option
            ...
            >
              <RadioGroup options={YES_NO_OPTIONS} control={control} name={RECORDS_DATESTAMP} />
            </Option>
            <Option
            ...
            >
              <RadioGroup options={YES_NO_OPTIONS} control={control} name={SYSTEMS_INTEGRATION} />
            </Option>
          </div>
          <Option
          ...
          <div className='two-col-content'>
            ...
            >
              <RadioGroup options={YES_NO_OPTIONS} control={control} name={SHARE_DATA} />
            </Option>
            <Option
